...
import { HrmsAppModule } from "./app.module";
...
async function bootstrap() {
  ...
  try {
    ...
    logger.info(`ℹCreando instancia del módulo HrmsAppModule...`);
    const app = await NestFactory.create(HrmsAppModule, {
    ...
    const swaggerPath = setupSwagger(
      ...
      "api-docs",
      "Hrms Service API",
      "API completa para gestión de Hrmss con documentación automática",
      "1.0"
    );
