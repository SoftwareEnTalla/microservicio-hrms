...
import { logger } from '@core/logs/logger';
  ...
  export class AttendanceStatusRepository {
    ...
    async findAndCount(where?: Record<string, any>): Promise<[AttendanceStatus[], number]> {
      logger.info('Ready to findByField AttendanceStatus on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of AttendanceStatus with id:  was finded on repository:', instance);
