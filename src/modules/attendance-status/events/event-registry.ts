...
import { AttendanceStatusCreatedEvent } from './attendancestatuscreated.event';
import { AttendanceStatusUpdatedEvent } from './attendancestatusupdated.event';
import { AttendanceStatusDeletedEvent } from './attendancestatusdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'attendance-status-created': createEventDefinition('attendance-status-created', AttendanceStatusCreatedEvent, EVENT_DEFINITION_OVERRIDES['attendance-status-created']),
  'attendance-status-updated': createEventDefinition('attendance-status-updated', AttendanceStatusUpdatedEvent, EVENT_DEFINITION_OVERRIDES['attendance-status-updated']),
  'attendance-status-deleted': createEventDefinition('attendance-status-deleted', AttendanceStatusDeletedEvent, EVENT_DEFINITION_OVERRIDES['attendance-status-deleted']),
