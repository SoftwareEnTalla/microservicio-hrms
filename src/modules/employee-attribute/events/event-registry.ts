...
import { EmployeeAttributeCreatedEvent } from './employeeattributecreated.event';
import { EmployeeAttributeUpdatedEvent } from './employeeattributeupdated.event';
import { EmployeeAttributeDeletedEvent } from './employeeattributedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'employee-attribute-created': createEventDefinition('employee-attribute-created', EmployeeAttributeCreatedEvent, EVENT_DEFINITION_OVERRIDES['employee-attribute-created']),
  'employee-attribute-updated': createEventDefinition('employee-attribute-updated', EmployeeAttributeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['employee-attribute-updated']),
  'employee-attribute-deleted': createEventDefinition('employee-attribute-deleted', EmployeeAttributeDeletedEvent, EVENT_DEFINITION_OVERRIDES['employee-attribute-deleted']),
