...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class ConfigurationParameterRepository {
    constructor(
    ...
    async findAndCount(where?: Record<string, any>): Promise<[ConfigurationParameter[], number]> {
      logger.info('Ready to findByField ConfigurationParameter on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of ConfigurationParameter with id:  was finded on repository:', instance);
