...
import { TrainingModalityCreatedEvent } from './trainingmodalitycreated.event';
import { TrainingModalityUpdatedEvent } from './trainingmodalityupdated.event';
import { TrainingModalityDeletedEvent } from './trainingmodalitydeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'training-modality-created': createEventDefinition('training-modality-created', TrainingModalityCreatedEvent, EVENT_DEFINITION_OVERRIDES['training-modality-created']),
  'training-modality-updated': createEventDefinition('training-modality-updated', TrainingModalityUpdatedEvent, EVENT_DEFINITION_OVERRIDES['training-modality-updated']),
  'training-modality-deleted': createEventDefinition('training-modality-deleted', TrainingModalityDeletedEvent, EVENT_DEFINITION_OVERRIDES['training-modality-deleted']),
