...
import { ReportsCategoryCreatedEvent } from './reportscategorycreated.event';
import { ReportsCategoryUpdatedEvent } from './reportscategoryupdated.event';
import { ReportsCategoryDeletedEvent } from './reportscategorydeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'reports-category-created': createEventDefinition('reports-category-created', ReportsCategoryCreatedEvent, EVENT_DEFINITION_OVERRIDES['reports-category-created']),
  'reports-category-updated': createEventDefinition('reports-category-updated', ReportsCategoryUpdatedEvent, EVENT_DEFINITION_OVERRIDES['reports-category-updated']),
  'reports-category-deleted': createEventDefinition('reports-category-deleted', ReportsCategoryDeletedEvent, EVENT_DEFINITION_OVERRIDES['reports-category-deleted']),
