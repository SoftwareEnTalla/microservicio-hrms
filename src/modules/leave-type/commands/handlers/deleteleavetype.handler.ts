...
import { DeleteLeaveTypeCommand } from "../deleteleavetype.command";
...
{
  constructor(
    private readonly commandService: LeaveTypeCommandService
  ) {}
  async execute(command: DeleteLeaveTypeCommand) {
