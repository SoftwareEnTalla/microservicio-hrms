...
import { LeaveTypeCreatedEvent } from './leavetypecreated.event';
import { LeaveTypeUpdatedEvent } from './leavetypeupdated.event';
import { LeaveTypeDeletedEvent } from './leavetypedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'leave-type-created': createEventDefinition('leave-type-created', LeaveTypeCreatedEvent, EVENT_DEFINITION_OVERRIDES['leave-type-created']),
  'leave-type-updated': createEventDefinition('leave-type-updated', LeaveTypeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['leave-type-updated']),
  'leave-type-deleted': createEventDefinition('leave-type-deleted', LeaveTypeDeletedEvent, EVENT_DEFINITION_OVERRIDES['leave-type-deleted']),
