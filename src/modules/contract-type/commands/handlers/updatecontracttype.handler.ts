...
import { UpdateContractTypeCommand } from "../updatecontracttype.command";
...
{
  constructor(
    private readonly commandService: ContractTypeCommandService
  ) {}
  async execute(command: UpdateContractTypeCommand) {
