...
import { ContractTypeCreatedEvent } from './contracttypecreated.event';
import { ContractTypeUpdatedEvent } from './contracttypeupdated.event';
import { ContractTypeDeletedEvent } from './contracttypedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'contract-type-created': createEventDefinition('contract-type-created', ContractTypeCreatedEvent, EVENT_DEFINITION_OVERRIDES['contract-type-created']),
  'contract-type-updated': createEventDefinition('contract-type-updated', ContractTypeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['contract-type-updated']),
  'contract-type-deleted': createEventDefinition('contract-type-deleted', ContractTypeDeletedEvent, EVENT_DEFINITION_OVERRIDES['contract-type-deleted']),
