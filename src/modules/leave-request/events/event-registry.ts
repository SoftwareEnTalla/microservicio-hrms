...
import { LeaveRequestCreatedEvent } from './leaverequestcreated.event';
import { LeaveRequestUpdatedEvent } from './leaverequestupdated.event';
import { LeaveRequestDeletedEvent } from './leaverequestdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'leave-request-created': createEventDefinition('leave-request-created', LeaveRequestCreatedEvent, EVENT_DEFINITION_OVERRIDES['leave-request-created']),
  'leave-request-updated': createEventDefinition('leave-request-updated', LeaveRequestUpdatedEvent, EVENT_DEFINITION_OVERRIDES['leave-request-updated']),
  'leave-request-deleted': createEventDefinition('leave-request-deleted', LeaveRequestDeletedEvent, EVENT_DEFINITION_OVERRIDES['leave-request-deleted']),
