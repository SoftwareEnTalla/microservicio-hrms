...
import { CredentialStatusCreatedEvent } from './credentialstatuscreated.event';
import { CredentialStatusUpdatedEvent } from './credentialstatusupdated.event';
import { CredentialStatusDeletedEvent } from './credentialstatusdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'credential-status-created': createEventDefinition('credential-status-created', CredentialStatusCreatedEvent, EVENT_DEFINITION_OVERRIDES['credential-status-created']),
  'credential-status-updated': createEventDefinition('credential-status-updated', CredentialStatusUpdatedEvent, EVENT_DEFINITION_OVERRIDES['credential-status-updated']),
  'credential-status-deleted': createEventDefinition('credential-status-deleted', CredentialStatusDeletedEvent, EVENT_DEFINITION_OVERRIDES['credential-status-deleted']),
