...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class CredentialStatusRepository {
    constructor(
    ...
    async findAndCount(where?: Record<string, any>): Promise<[CredentialStatus[], number]> {
      logger.info('Ready to findByField CredentialStatus on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of CredentialStatus with id:  was finded on repository:', instance);
