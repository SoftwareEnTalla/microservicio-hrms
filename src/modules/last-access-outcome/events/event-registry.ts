...
import { LastAccessOutcomeCreatedEvent } from './lastaccessoutcomecreated.event';
import { LastAccessOutcomeUpdatedEvent } from './lastaccessoutcomeupdated.event';
import { LastAccessOutcomeDeletedEvent } from './lastaccessoutcomedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'last-access-outcome-created': createEventDefinition('last-access-outcome-created', LastAccessOutcomeCreatedEvent, EVENT_DEFINITION_OVERRIDES['last-access-outcome-created']),
  'last-access-outcome-updated': createEventDefinition('last-access-outcome-updated', LastAccessOutcomeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['last-access-outcome-updated']),
  'last-access-outcome-deleted': createEventDefinition('last-access-outcome-deleted', LastAccessOutcomeDeletedEvent, EVENT_DEFINITION_OVERRIDES['last-access-outcome-deleted']),
