...
import { PersonAttributeCreatedEvent } from './personattributecreated.event';
import { PersonAttributeUpdatedEvent } from './personattributeupdated.event';
import { PersonAttributeDeletedEvent } from './personattributedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'person-attribute-created': createEventDefinition('person-attribute-created', PersonAttributeCreatedEvent, EVENT_DEFINITION_OVERRIDES['person-attribute-created']),
  'person-attribute-updated': createEventDefinition('person-attribute-updated', PersonAttributeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['person-attribute-updated']),
  'person-attribute-deleted': createEventDefinition('person-attribute-deleted', PersonAttributeDeletedEvent, EVENT_DEFINITION_OVERRIDES['person-attribute-deleted']),
