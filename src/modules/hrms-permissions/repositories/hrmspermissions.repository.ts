...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class HrmsPermissionsRepository {
    constructor(
    ...
    async findAndCount(where?: Record<string, any>): Promise<[HrmsPermissions[], number]> {
      logger.info('Ready to findByField HrmsPermissions on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of HrmsPermissions with id:  was finded on repository:', instance);
