...
import { ConfigurationParameterScopeCreatedEvent } from './configurationparameterscopecreated.event';
import { ConfigurationParameterScopeUpdatedEvent } from './configurationparameterscopeupdated.event';
import { ConfigurationParameterScopeDeletedEvent } from './configurationparameterscopedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'configuration-parameter-scope-created': createEventDefinition('configuration-parameter-scope-created', ConfigurationParameterScopeCreatedEvent, EVENT_DEFINITION_OVERRIDES['configuration-parameter-scope-created']),
  'configuration-parameter-scope-updated': createEventDefinition('configuration-parameter-scope-updated', ConfigurationParameterScopeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['configuration-parameter-scope-updated']),
  'configuration-parameter-scope-deleted': createEventDefinition('configuration-parameter-scope-deleted', ConfigurationParameterScopeDeletedEvent, EVENT_DEFINITION_OVERRIDES['configuration-parameter-scope-deleted']),
