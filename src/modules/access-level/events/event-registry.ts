...
import { AccessLevelCreatedEvent } from './accesslevelcreated.event';
import { AccessLevelUpdatedEvent } from './accesslevelupdated.event';
import { AccessLevelDeletedEvent } from './accessleveldeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'access-level-created': createEventDefinition('access-level-created', AccessLevelCreatedEvent, EVENT_DEFINITION_OVERRIDES['access-level-created']),
  'access-level-updated': createEventDefinition('access-level-updated', AccessLevelUpdatedEvent, EVENT_DEFINITION_OVERRIDES['access-level-updated']),
  'access-level-deleted': createEventDefinition('access-level-deleted', AccessLevelDeletedEvent, EVENT_DEFINITION_OVERRIDES['access-level-deleted']),
