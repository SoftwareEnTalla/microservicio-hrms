...
import { GetAttendanceByFieldQuery } from '../getattendancebyfield.query';
import { AttendanceQueryService } from '../../services/attendancequery.service';

@QueryHandler(GetAttendanceByFieldQuery)
export class GetAttendanceByFieldHandler implements IQueryHandler<GetAttendanceByFieldQuery> {
  constructor(private readonly queryService: AttendanceQueryService) {}

  async execute(query: GetAttendanceByFieldQuery) {
