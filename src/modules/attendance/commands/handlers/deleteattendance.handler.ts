...
import { DeleteAttendanceCommand } from "../deleteattendance.command";
...
{
  constructor(
    private readonly commandService: AttendanceCommandService
  ) {}
  async execute(command: DeleteAttendanceCommand) {
