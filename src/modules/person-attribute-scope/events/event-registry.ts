...
import { PersonAttributeScopeCreatedEvent } from './personattributescopecreated.event';
import { PersonAttributeScopeUpdatedEvent } from './personattributescopeupdated.event';
import { PersonAttributeScopeDeletedEvent } from './personattributescopedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'person-attribute-scope-created': createEventDefinition('person-attribute-scope-created', PersonAttributeScopeCreatedEvent, EVENT_DEFINITION_OVERRIDES['person-attribute-scope-created']),
  'person-attribute-scope-updated': createEventDefinition('person-attribute-scope-updated', PersonAttributeScopeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['person-attribute-scope-updated']),
  'person-attribute-scope-deleted': createEventDefinition('person-attribute-scope-deleted', PersonAttributeScopeDeletedEvent, EVENT_DEFINITION_OVERRIDES['person-attribute-scope-deleted']),
