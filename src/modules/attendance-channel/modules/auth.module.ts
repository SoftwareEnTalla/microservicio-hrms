...
@Module({
  controllers: [AttendanceChannelCommandController],
  providers: [
  ...
  exports: [AttendanceChannelAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthAttendanceChannelModule {}
