...
import { AttendanceChannelCreatedEvent } from './attendancechannelcreated.event';
import { AttendanceChannelUpdatedEvent } from './attendancechannelupdated.event';
import { AttendanceChannelDeletedEvent } from './attendancechanneldeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'attendance-channel-created': createEventDefinition('attendance-channel-created', AttendanceChannelCreatedEvent, EVENT_DEFINITION_OVERRIDES['attendance-channel-created']),
  'attendance-channel-updated': createEventDefinition('attendance-channel-updated', AttendanceChannelUpdatedEvent, EVENT_DEFINITION_OVERRIDES['attendance-channel-updated']),
  'attendance-channel-deleted': createEventDefinition('attendance-channel-deleted', AttendanceChannelDeletedEvent, EVENT_DEFINITION_OVERRIDES['attendance-channel-deleted']),
