...
@Module({
  controllers: [HrmsPermissionsSourceCommandController],
  providers: [
  ...
  exports: [HrmsPermissionsSourceAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthHrmsPermissionsSourceModule {}
