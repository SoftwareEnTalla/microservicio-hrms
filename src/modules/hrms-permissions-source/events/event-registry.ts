...
import { HrmsPermissionsSourceCreatedEvent } from './hrmspermissionssourcecreated.event';
import { HrmsPermissionsSourceUpdatedEvent } from './hrmspermissionssourceupdated.event';
import { HrmsPermissionsSourceDeletedEvent } from './hrmspermissionssourcedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'hrms-permissions-source-created': createEventDefinition('hrms-permissions-source-created', HrmsPermissionsSourceCreatedEvent, EVENT_DEFINITION_OVERRIDES['hrms-permissions-source-created']),
  'hrms-permissions-source-updated': createEventDefinition('hrms-permissions-source-updated', HrmsPermissionsSourceUpdatedEvent, EVENT_DEFINITION_OVERRIDES['hrms-permissions-source-updated']),
  'hrms-permissions-source-deleted': createEventDefinition('hrms-permissions-source-deleted', HrmsPermissionsSourceDeletedEvent, EVENT_DEFINITION_OVERRIDES['hrms-permissions-source-deleted']),
