...
export class PayrollService {
  ...
  // Métodos delegados
  async findAll(options?: any): Promise<Payroll[]> {
  ...
  async findByField(field: string, value: any, page: number, limit: number): Promise<Payroll[]> {
    return this.repository.findByField(field, value, page, limit);
  }

  async findWithPagination(options: any, page: number, limit: number): Promise<Payroll[]> {
  ...
  async update(id: string, partialEntity: Partial<Payroll>): Promise<Payroll | null> {
