...
import { GetPayrollByFieldQuery } from '../getpayrollbyfield.query';
import { PayrollQueryService } from '../../services/payrollquery.service';

@QueryHandler(GetPayrollByFieldQuery)
export class GetPayrollByFieldHandler implements IQueryHandler<GetPayrollByFieldQuery> {
  constructor(private readonly queryService: PayrollQueryService) {}

  async execute(query: GetPayrollByFieldQuery) {
