...
import { GetPayrollByIdQuery } from '../getpayrollbyid.query';
import { PayrollQueryService } from '../../services/payrollquery.service';

@QueryHandler(GetPayrollByIdQuery)
export class GetPayrollByIdHandler implements IQueryHandler<GetPayrollByIdQuery> {
  constructor(private readonly queryService: PayrollQueryService) {}

  async execute(query: GetPayrollByIdQuery) {
