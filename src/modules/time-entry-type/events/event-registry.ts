...
import { TimeEntryTypeCreatedEvent } from './timeentrytypecreated.event';
import { TimeEntryTypeUpdatedEvent } from './timeentrytypeupdated.event';
import { TimeEntryTypeDeletedEvent } from './timeentrytypedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'time-entry-type-created': createEventDefinition('time-entry-type-created', TimeEntryTypeCreatedEvent, EVENT_DEFINITION_OVERRIDES['time-entry-type-created']),
  'time-entry-type-updated': createEventDefinition('time-entry-type-updated', TimeEntryTypeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['time-entry-type-updated']),
  'time-entry-type-deleted': createEventDefinition('time-entry-type-deleted', TimeEntryTypeDeletedEvent, EVENT_DEFINITION_OVERRIDES['time-entry-type-deleted']),
