...
import { GetReportsByFieldQuery } from '../getreportsbyfield.query';
import { ReportsQueryService } from '../../services/reportsquery.service';

@QueryHandler(GetReportsByFieldQuery)
export class GetReportsByFieldHandler implements IQueryHandler<GetReportsByFieldQuery> {
  constructor(private readonly queryService: ReportsQueryService) {}

  async execute(query: GetReportsByFieldQuery) {
