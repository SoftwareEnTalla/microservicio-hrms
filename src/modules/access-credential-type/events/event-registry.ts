...
import { AccessCredentialTypeCreatedEvent } from './accesscredentialtypecreated.event';
import { AccessCredentialTypeUpdatedEvent } from './accesscredentialtypeupdated.event';
import { AccessCredentialTypeDeletedEvent } from './accesscredentialtypedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'access-credential-type-created': createEventDefinition('access-credential-type-created', AccessCredentialTypeCreatedEvent, EVENT_DEFINITION_OVERRIDES['access-credential-type-created']),
  'access-credential-type-updated': createEventDefinition('access-credential-type-updated', AccessCredentialTypeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['access-credential-type-updated']),
  'access-credential-type-deleted': createEventDefinition('access-credential-type-deleted', AccessCredentialTypeDeletedEvent, EVENT_DEFINITION_OVERRIDES['access-credential-type-deleted']),
