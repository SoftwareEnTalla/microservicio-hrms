...
import { ScopeTypeCreatedEvent } from './scopetypecreated.event';
import { ScopeTypeUpdatedEvent } from './scopetypeupdated.event';
import { ScopeTypeDeletedEvent } from './scopetypedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'scope-type-created': createEventDefinition('scope-type-created', ScopeTypeCreatedEvent, EVENT_DEFINITION_OVERRIDES['scope-type-created']),
  'scope-type-updated': createEventDefinition('scope-type-updated', ScopeTypeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['scope-type-updated']),
  'scope-type-deleted': createEventDefinition('scope-type-deleted', ScopeTypeDeletedEvent, EVENT_DEFINITION_OVERRIDES['scope-type-deleted']),
