...
import { GenderCreatedEvent } from './gendercreated.event';
import { GenderUpdatedEvent } from './genderupdated.event';
import { GenderDeletedEvent } from './genderdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'gender-created': createEventDefinition('gender-created', GenderCreatedEvent, EVENT_DEFINITION_OVERRIDES['gender-created']),
  'gender-updated': createEventDefinition('gender-updated', GenderUpdatedEvent, EVENT_DEFINITION_OVERRIDES['gender-updated']),
  'gender-deleted': createEventDefinition('gender-deleted', GenderDeletedEvent, EVENT_DEFINITION_OVERRIDES['gender-deleted']),
