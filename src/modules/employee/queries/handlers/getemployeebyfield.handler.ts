...
import { GetEmployeeByFieldQuery } from '../getemployeebyfield.query';
import { EmployeeQueryService } from '../../services/employeequery.service';

@QueryHandler(GetEmployeeByFieldQuery)
export class GetEmployeeByFieldHandler implements IQueryHandler<GetEmployeeByFieldQuery> {
  constructor(private readonly queryService: EmployeeQueryService) {}

  async execute(query: GetEmployeeByFieldQuery) {
