...
import { PayrollFrequencyCreatedEvent } from './payrollfrequencycreated.event';
import { PayrollFrequencyUpdatedEvent } from './payrollfrequencyupdated.event';
import { PayrollFrequencyDeletedEvent } from './payrollfrequencydeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'payroll-frequency-created': createEventDefinition('payroll-frequency-created', PayrollFrequencyCreatedEvent, EVENT_DEFINITION_OVERRIDES['payroll-frequency-created']),
  'payroll-frequency-updated': createEventDefinition('payroll-frequency-updated', PayrollFrequencyUpdatedEvent, EVENT_DEFINITION_OVERRIDES['payroll-frequency-updated']),
  'payroll-frequency-deleted': createEventDefinition('payroll-frequency-deleted', PayrollFrequencyDeletedEvent, EVENT_DEFINITION_OVERRIDES['payroll-frequency-deleted']),
