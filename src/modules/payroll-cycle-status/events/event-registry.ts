...
import { PayrollCycleStatusCreatedEvent } from './payrollcyclestatuscreated.event';
import { PayrollCycleStatusUpdatedEvent } from './payrollcyclestatusupdated.event';
import { PayrollCycleStatusDeletedEvent } from './payrollcyclestatusdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'payroll-cycle-status-created': createEventDefinition('payroll-cycle-status-created', PayrollCycleStatusCreatedEvent, EVENT_DEFINITION_OVERRIDES['payroll-cycle-status-created']),
  'payroll-cycle-status-updated': createEventDefinition('payroll-cycle-status-updated', PayrollCycleStatusUpdatedEvent, EVENT_DEFINITION_OVERRIDES['payroll-cycle-status-updated']),
  'payroll-cycle-status-deleted': createEventDefinition('payroll-cycle-status-deleted', PayrollCycleStatusDeletedEvent, EVENT_DEFINITION_OVERRIDES['payroll-cycle-status-deleted']),
