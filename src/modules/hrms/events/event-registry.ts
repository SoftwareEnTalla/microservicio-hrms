...
import { HrmsCreatedEvent } from './hrmscreated.event';
import { HrmsUpdatedEvent } from './hrmsupdated.event';
import { HrmsDeletedEvent } from './hrmsdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'hrms-created': createEventDefinition('hrms-created', HrmsCreatedEvent, EVENT_DEFINITION_OVERRIDES['hrms-created']),
  'hrms-updated': createEventDefinition('hrms-updated', HrmsUpdatedEvent, EVENT_DEFINITION_OVERRIDES['hrms-updated']),
  'hrms-deleted': createEventDefinition('hrms-deleted', HrmsDeletedEvent, EVENT_DEFINITION_OVERRIDES['hrms-deleted']),
