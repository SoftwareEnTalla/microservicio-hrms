...
import { EmploymentStatusCreatedEvent } from './employmentstatuscreated.event';
import { EmploymentStatusUpdatedEvent } from './employmentstatusupdated.event';
import { EmploymentStatusDeletedEvent } from './employmentstatusdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'employment-status-created': createEventDefinition('employment-status-created', EmploymentStatusCreatedEvent, EVENT_DEFINITION_OVERRIDES['employment-status-created']),
  'employment-status-updated': createEventDefinition('employment-status-updated', EmploymentStatusUpdatedEvent, EVENT_DEFINITION_OVERRIDES['employment-status-updated']),
  'employment-status-deleted': createEventDefinition('employment-status-deleted', EmploymentStatusDeletedEvent, EVENT_DEFINITION_OVERRIDES['employment-status-deleted']),
