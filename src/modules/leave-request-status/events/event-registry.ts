...
import { LeaveRequestStatusCreatedEvent } from './leaverequeststatuscreated.event';
import { LeaveRequestStatusUpdatedEvent } from './leaverequeststatusupdated.event';
import { LeaveRequestStatusDeletedEvent } from './leaverequeststatusdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'leave-request-status-created': createEventDefinition('leave-request-status-created', LeaveRequestStatusCreatedEvent, EVENT_DEFINITION_OVERRIDES['leave-request-status-created']),
  'leave-request-status-updated': createEventDefinition('leave-request-status-updated', LeaveRequestStatusUpdatedEvent, EVENT_DEFINITION_OVERRIDES['leave-request-status-updated']),
  'leave-request-status-deleted': createEventDefinition('leave-request-status-deleted', LeaveRequestStatusDeletedEvent, EVENT_DEFINITION_OVERRIDES['leave-request-status-deleted']),
