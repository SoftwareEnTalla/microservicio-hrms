...
@Module({
  controllers: [LeaveRequestStatusCommandController],
  providers: [
  ...
  exports: [LeaveRequestStatusAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthLeaveRequestStatusModule {}
