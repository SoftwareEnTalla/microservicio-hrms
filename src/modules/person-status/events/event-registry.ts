...
import { PersonStatusCreatedEvent } from './personstatuscreated.event';
import { PersonStatusUpdatedEvent } from './personstatusupdated.event';
import { PersonStatusDeletedEvent } from './personstatusdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'person-status-created': createEventDefinition('person-status-created', PersonStatusCreatedEvent, EVENT_DEFINITION_OVERRIDES['person-status-created']),
  'person-status-updated': createEventDefinition('person-status-updated', PersonStatusUpdatedEvent, EVENT_DEFINITION_OVERRIDES['person-status-updated']),
  'person-status-deleted': createEventDefinition('person-status-deleted', PersonStatusDeletedEvent, EVENT_DEFINITION_OVERRIDES['person-status-deleted']),
